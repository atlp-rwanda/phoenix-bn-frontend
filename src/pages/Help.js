  ...
  return (
    <div className='w-screen overflow-hidden'>
     ...
     <p className='font-bold text-2xl md:text-4xl mb-3 mt-11'>Frequently Asked Questions</p>
        ...
        <li>Every trip request is accepted?</li><span className="text-blue-500">No some times we cancel any trip request when there is some thing that is not good</span>
        </ul></p>
      </div>
    </div>
  )
