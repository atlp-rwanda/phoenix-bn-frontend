...
class  TopNav extends React.Component {
    toggleaRole=()=>{
const mobileToggle=document.getElementById("menu");
   mobileToggle.classList.toggle("hidden");
    }
    
render(){
    let position = this.props.position ? this.props.position : 'relative';
    position+=' w-full h-auto z-10';
    return (
        <div className={position}>
            <nav className="flex justify-between bg-white w-full md:w-topNav  p-3 md:py-3 md:pl-4  md:pr-28 h-full md:rounded-br-full">
                ...
                <button onClick={this.toggleaRole} className="lg:hidden block">
        ...
        <div className="hidden text-center z-0 lg:items-center bg-white lg:w-auto" id="menu">
