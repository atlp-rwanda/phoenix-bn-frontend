  ...
  render() {
    ...
    return (
      <div className="absolute w-full h-auto z-10">
        <nav className="flex border-b border-gray-300 justify-between bg-white w-full md:w-topNav  p-3 md:py-3 md:pl-4  md:pr-28 h-full md:rounded-br-full relative">
          ...
          <button
            ...
            id="toggle_button"
            className="lg:hidden block btn-submit mt-0 outline-none absolute right-8"
          >
