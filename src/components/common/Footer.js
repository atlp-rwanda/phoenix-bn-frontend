...
<Fragment>
    ...
    <h1 className="text-gray-200 font-bold text-4xl font-Sansation">BareFoot</h1><p className="max-h-full p-1 pt-5 mb-2  text-gray-200 font-bold md:text-lg font-Sansation">Barefoot is a grobal travel and accomodation website for nomads we make your travel experience more wonderful with our incomperable services.</p>
    </div></li>
    <li className="rounded-lg  md:mr-12 md:p-12"><div className="max-h-full">
    <h1 className="text-gray-200 font-bold text-4xl font-Sansation">Contact</h1><p className="text-gray-200 pt-5 font-bold md:text-lg font-Sansation">Barefoot customer services<br /> +250785855328<br />barefoot@gmail.com</p>
