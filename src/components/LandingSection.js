               ...
               <div id='text-content' className='absolute space-y-6 flex pl-5 sm:pl-20 font-Sansation font-bold text-white  left-0 border-box top-0 h-max-97 w-full mt-52'>
                 ...
                 <p className='text-4xl'>Book early save more</p>
                  ...
                  <div className='relative'>
                     ...
                     <button
            className="inline-block px-6 py-2 text-sm font-bold leading-6 text-center text-white uppercase transition bg-green-500 rounded-full shadow ripple hover:shadow-lg hover:bg-green-600 focus:outline-none"
          >
            Get started
          </button>
                  </div>
